...
-ignorewarnings
#以下是不需要混淆的文件
 -keep class com.xuanyuanxinyu.lib.** {*;}
...
#-libraryjars libs/android-support-v4.jar  ，假设工程中有这个包
...
# 保留JS方法不被混淆  ,其中JSInterface是MainActivity的子类
...
-keep class com.ut.*
#-libraryjars libs/alipaysdk.jar    需要有着jar才可使用
