...
//                }
                ...
                sendStatus2Fpms(flag, HeartBeatServcice.this);
//              sendCheck2Fpms(HeartBeatServcice.this);
    ...
    private void sendStatus2Fpms(int userStatus, VolleyListener listener) {
        ...
        String cmdECB = AESUtils.encryptDESedeECB("updateStatus", dataKey);
    ...
    private void sendCheck2Fpms(VolleyListener listener) {
        ...
        String cmdECB = AESUtils.encryptDESedeECB("deviceCheck", dataKey);
        String sb = ("service=deviceService&cmd=" + cmdECB) +
                "&authenCode=" + authenCode +
                "&appCode=FPMSWS" +
                ...
                "&initAd=" + 2641289;
        String data = AESUtils.encryptDESedeECB(sb//校准点的AD值
                , MAIN_KEY);
