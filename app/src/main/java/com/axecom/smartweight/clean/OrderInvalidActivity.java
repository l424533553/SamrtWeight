...
//import com.xuanyuan.library.activity.MyBuglyActivity;
...
//        @SuppressLint("InflateParams") View rootView = LayoutInflater.from(this).inflate(R.layout.order_invalid_activity, null);
...
//
//        List<UnusualOrdersBean.Order> orderList = new ArrayList<>();
//        Map<String, UnusualOrdersBean.Order> orderMap = new HashMap<>();
//        OrderAdapter orderAdapter = new OrderAdapter(this, orderMap, orderList);
