...
//import com.xuanyuan.library.help.system.MacOrIPManager;
...
//                .getOrders(AccountManager.getInstance(context).getAdminToken(), MacOrIPManager.getInstace(this).getMac(), page, pageNum, typeVal)
