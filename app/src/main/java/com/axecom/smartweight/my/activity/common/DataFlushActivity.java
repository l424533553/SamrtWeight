...
import com.axecom.smartweight.my.entity.ResultInfoSmall;
...
import static com.axecom.smartweight.my.config.IConstants.HANDLER_IMAGE_FINISH;
import static com.axecom.smartweight.my.config.IConstants.HANDLER_SECOND_IMAGE;
import static com.axecom.smartweight.my.config.IConstants.HANDLER_SMALL_ROUTINE;
import static com.axecom.smartweight.my.config.IConstants.HANDLER_UPDATE_ALLGOOD;
import static com.axecom.smartweight.my.config.IConstants.HANDLER_UPDATE_FINISH;
import static com.axecom.smartweight.my.config.IConstants.HANDLER_UPDATE_GOOD_TYPE;
import static com.axecom.smartweight.my.config.IConstants.INTENT_AUTO_UPDATE;
import static com.axecom.smartweight.my.config.IConstants.SMALLROUTINE_URL;
import static com.axecom.smartweight.my.config.IConstants.SP_IS_FIRST_INIT;
...
//                        isHotGood = true;
                ...
                case 5:
                    ...
                    if (result != null && result.getCode() == 0) {
                        ...
                        // 更新小程序二维码
                        BaseBusEvent event = new BaseBusEvent();
                        event.setEventType(NOTIFY_SMALLL_ROUTINE);
                        EventBus.getDefault().post(event);
                        isSmallRoutine = true;
                        tvSmallRoutine.setText("更新成功");
                    } else {
