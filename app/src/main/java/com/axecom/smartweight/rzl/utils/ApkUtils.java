...
public class ApkUtils implements VolleyListener {
    private static final String TAG = com.axecom.smartweight.rzl.utils.ApkUtils.class.getSimpleName();
    ...
    public static void installUseAS(Context context, String filePath) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                Uri contentUri = FileProvider.getUriForFile(com.axecom.smartweight.rzl.utils.ApkUtils.getInstance().ctx, "com.axecom.iweight.fileprovider", apkFile);//com.dtncpzs.traceback.fileprovider
...
//                                if (_newVersion > _oldVersion) {//开始下载
    ...
    private static com.axecom.smartweight.rzl.utils.ApkUtils myself;

    public static com.axecom.smartweight.rzl.utils.ApkUtils getInstance() {
        if (myself == null) {
            myself = new com.axecom.smartweight.rzl.utils.ApkUtils();
        }
        return myself;
    }
}
