package com.axecom.smartweight.carouselservice1.entity;


import android.content.Context;
import android.database.Cursor;

import com.axecom.smartweight.my.entity.dao.OrmliteBaseHelper;
...
public class ImageDao {
    ...
    public ImageDao(Context context) {
        try {
            ...
            this.dao = ormliteBaseHelper.getDao(AdImageInfo.class);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }

    private ImageDao baseDao;

    public ImageDao getInstance(Context context) {
        if (baseDao == null) {
