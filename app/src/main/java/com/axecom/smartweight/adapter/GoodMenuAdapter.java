...
//    }
    ...
    public List<HotGood> getList() {
        return list;
    }

    public void setDatas(List<HotGood> data) {
        list = data;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        HotGood hotGood = list.get(position);
        holder.commodityBtn.setText(hotGood.getName());
        ...
        holder.tag.setVisibility(TextUtils.isEmpty(hotGood.getBatchCode()) ? View.GONE : View.VISIBLE);
