 ...
 * 香山秤15.6 黑色屏
 */
public class XSWeighterAXE extends MyBaseWeighter  implements IEventBus {
    private static XSWeighterAXE mInstance;

    public static XSWeighterAXE getXSWeighter() {
        return mInstance;
    }

    public XSWeighterAXE() {
        mInstance = this;
    }
